### Note: A comprehensive breakdown of the project is contained in the "flood susceptibility" article/report; the jupyter notebook just bears the project code.
