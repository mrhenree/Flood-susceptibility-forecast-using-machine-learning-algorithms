### Note: A comprehensive breakdown of the project is contained in the "Flood_susceptibility_forecast_using_machine_learning_models-3" paper; the jupyter notebook just bears the project code.
